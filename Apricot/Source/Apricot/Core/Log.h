...
namespace Apricot {
	...
	public:
		...
		{
			Format(s_Buffer, sizeof(s_Buffer), message, std::forward<Args>(args)...);
			Write(type, s_Buffer);
		}
...
*/
	...
	#define AE_CORE_FATAL(...) Apricot::ALogger::WriteError(Apricot::Log::Fatal, __VA_ARGS__)
#else
...
*/
	...
	#define AE_CORE_ERROR(...) Apricot::ALogger::WriteError(Apricot::Log::Error, __VA_ARGS__)
#else
...
*/
	...
	#define AE_CORE_WARN(...) Apricot::ALogger::Write(Apricot::Log::Warn, __VA_ARGS__)
#else
	#define AE_CORE_WARN(...) 
#endif
...
*/
	...
	#define AE_CORE_INFO(...) Apricot::ALogger::Write(Apricot::Log::Info, __VA_ARGS__)
#else
	#define AE_CORE_INFO(...) 
#endif
...
*/
	...
	#define AE_CORE_DEBUG(...) Apricot::ALogger::Write(Apricot::Log::Debug, __VA_ARGS__)
#else
...
*/
	...
	#define AE_CORE_TRACE(...) Apricot::ALogger::Write(Apricot::Log::Trace, __VA_ARGS__)
#else
